...
namespace OGATests
{
    public class StudentAbsVMTests
    {
        ...
        public void Absences_EtudiantAbsentDeuxCours_DeuxLignes()
        {
            ...
            var vm = new StudentAbsVM(etudiant, cours);
        ...
        {
            var etudiant = new Student("001", "Potter", "Harry");
            var cours = new[] { Cours("Maths", "Mme Serrier", 120, DateTime.Today, "002") };
        ...
        {
            var etudiant = new Student("001", "Potter", "Harry");
            var cours = new[] { Cours("Maths", "Mme Serrier", 120, new DateTime(2025, 2, 17, 10, 0, 0), "001") };

            var vm = new StudentAbsVM(etudiant, cours);

            Assert.Equal("17/02/2025, 10:00, Maths (Mme Serrier), 120 min", vm.Absences[0]);
        }
        ...
        public void Absences_TrieeParDateDecroissante()
        {
            ...
            Assert.StartsWith("20/02/2025", vm.Absences[0]);
        }
        ...
        public void StudentFullName_NomComplet()
        {
            ...
            var vm = new StudentAbsVM(etudiant, Array.Empty<Course>());
